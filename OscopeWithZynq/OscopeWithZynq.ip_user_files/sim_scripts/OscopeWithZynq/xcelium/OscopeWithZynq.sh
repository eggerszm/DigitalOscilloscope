...
#
# Script generated by Vivado on Wed Dec 06 11:00:40 -0700 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : OscopeWithZynq.sh
...
#
# Usage        : OscopeWithZynq.sh
#                OscopeWithZynq.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                OscopeWithZynq.sh [-reset_run]
#                OscopeWithZynq.sh [-reset_log]
#                OscopeWithZynq.sh [-help]
#
...
#                script (type 'OscopeWithZynq.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname generic_baseblocks_v2_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname blk_mem_gen_v8_4_6 -libname axi_protocol_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 blk_mem_gen_v8_4_6 axi_protocol_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "OscopeWithZynq.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./OscopeWithZynq.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ipshared/aed8/hdl" +incdir+"$ref_dir/../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ip/OscopeWithZynq_acquireToHDMI_0_0/src/clk_wiz_0" +incdir+"../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ipshared/ec67/hdl" +incdir+"../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ipshared/aed8/hdl" +incdir+"../../../../OscopeWithZynq.gen/sources_1/bd/OscopeWithZynq/ip/OscopeWithZynq_acquireToHDMI_0_0/src/clk_wiz_0" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.OscopeWithZynq xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.OscopeWithZynq -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log OscopeWithZynq_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./OscopeWithZynq.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: OscopeWithZynq.sh [-help]\n\
Usage: OscopeWithZynq.sh [-step]\n\
Usage: OscopeWithZynq.sh [-lib_map_path]\n\
Usage: OscopeWithZynq.sh [-reset_run]\n\
Usage: OscopeWithZynq.sh [-reset_log]\n\
Usage: OscopeWithZynq.sh [-keep_index]\n\
Usage: OscopeWithZynq.sh [-noclean_files]\n\n\
