...
set_property IOSTANDARD LVCMOS33 [get_ports forcedModeOut_ext_0]

set_property PACKAGE_PIN N15 [get_ports btn_ext_0[0]]
set_property IOSTANDARD LVCMOS33 [get_ports btn_ext_0[0]]

set_property PACKAGE_PIN T17 [get_ports btn_ext_0[1]]
set_property IOSTANDARD LVCMOS33 [get_ports btn_ext_0[1]]

set_property PACKAGE_PIN N16 [get_ports btn_ext_0[2]]
set_property IOSTANDARD LVCMOS33 [get_ports btn_ext_0[2]]
